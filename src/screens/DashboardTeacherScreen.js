      ...
      <View style={styles.section}>
        ...
        <View style={styles.templateCard}>
          ...
          <View style={styles.templateContent}>
            ...
            <Text style={styles.templateText}>Include room number, time noticed, and any unusual noise.</Text>
          </View>
        </View>
        <View style={styles.templateCard}>
          <Ionicons name="bulb-outline" size={18} color={colors.primary} />
          <View style={styles.templateContent}>
            ...
            <Text style={styles.templateText}>Mention model, input source, and error message on screen.</Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  templateText: { fontSize: fontSize.xs, color: colors.textSecondary, marginTop: 2, lineHeight: 18 },
  logoutButton: {
